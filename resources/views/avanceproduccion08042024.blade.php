          ...
          <div class="card card-stats">
            ...
            <div class="card-icon">
             ...
             //   $hora = date("H").":00 ";
                $dia_semana = date("N");
              @endphp
              @if(strtotime($hora_actualizacionI) != strtotime($hora) || $hora_actualizacionI == 'N/D' || strtotime($hora_actualizacionII) != strtotime($hora) || $hora_actualizacionII == 'N/D' )
                @php
                  $color2 = "red";
                @endphp
              @else
            ...
            <div class="card-footer" style="align:center">
                ...
                <p class="stats"><span class="text-info"> Piezas Reales :</span><b>  {{ ' '.number_format( ($real_x_plantaI-$real_x_plantaI830)+($real_x_plantaII-$real_x_plantaI831),0) }}</b></p>
                <p class="stats"><span class="text-info"> Diferencia :</span><b>@if(((($real_x_plantaI-$real_x_plantaI830)+($real_x_plantaII-$real_x_plantaI831))-($cantidad_plantaI+$cantidad_plantaII))<0)<font color=red> @else <font color=blue> @endif {{ ' '.number_format(((($real_x_plantaI-$real_x_plantaI830)+($real_x_plantaII-$real_x_plantaI831))-($cantidad_plantaI+$cantidad_plantaII)),0) }}</font></b></p>
            </div>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="card card-stats">
            ...
            <div class="card-footer" style="align:center">
                ...
                <p class="stats"><span class="text-info"> Piezas Reales :</span><b>  {{ ' '.number_format($cantidad_semanal+(($real_x_plantaI-$real_x_plantaI830)+($real_x_plantaII-$real_x_plantaI831)),0) }}</b></p>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="card card-stats">
            ...
            <div class="card-footer" style="align:center">
            <p class="stats"><span class="text-warning"> Piezas Meta : </span><b>  {{ ' '.number_format($cantidad_plantaI,0) }}</b></p>
                <p class="stats"><span class="text-warning"> Piezas Reales :</span><b>  {{ ' '.number_format($real_x_plantaI-$real_x_plantaI830,0) }}</b></p>
                <p class="stats"><span class="text-warning"> Diferencia :</span><b> @if((($real_x_plantaI-$real_x_plantaI830)-$cantidad_plantaI)<0)<font color=red> @else <font color=blue> @endif{{ ' '.number_format(($real_x_plantaI-$real_x_plantaI830)-$cantidad_plantaI,0) }} </font></b></p>
                    </div>
      ...
      <div class="row">
       ...
       @if ($cantidad_CHICOS != 0)
        ...
        <!--    <div class="card-footer">
              <div class="stats">
                <i class="material-icons ">date_range</i>
                <a href="{{ route('excepciones') }}">Detalle por planta...</a>
              </div>
            </div>-->
          </div>
        </div>
              ...
              <div class="tab-pane" id="profile">
                  ...
                  <div class="card-body table-responsive">
                    ...
                    <table class="table-cebra table-fixed">
                      ...
                      <tbody>
                        @foreach($team_leader as $team)
                          @if($team->planta == 'IntimarkI' )
                            <tr>
                              @php
                                $meta_team=($team->piezas_meta/$horas_laboradas)*$valor_hora;
                              @endphp
                              <td class="text-info">{{ $team->team_leader }} </td>
                              <td  style="text-align: center">{{ number_format($meta_team,0) }}</td>
                              <td  style="text-align: center">{{ number_format($team->eficiencia_dia,1).' %' }}</td>
                              ...
                              <td  style="text-align: center"><font color={{ $color }}>{{ number_format($team->efic,1).' %' }}</font></td>
                    ...
                    <table class="table-cebra table-fixed">
                      ...
                      <tbody>
                        @foreach($team_leader as $teamII)
                          @if($teamII->planta == 'IntimarkII' )
                            <tr>
                              @php
                                $meta_team=($teamII->piezas_meta/$horas_laboradas)*$valor_hora;
                              @endphp
                              <td class="text-info">{{ $teamII->team_leader }} </td>
                              <td  style="text-align: center">{{ number_format($meta_team,0) }}</td>
                              <td  style="text-align: center">{{ number_format($teamII->eficiencia_dia,1).' %' }}</td>
                              <td  style="text-align: center">{{ number_format($teamII->piezas,0) }}</td>

                              @if($teamII->eficiencia_dia > $teamII->efic)
                                @php
                                  $color = "red";
                                @endphp
                               @else
                              ...
                              <td  style="text-align: center"><font color={{ $color }}>{{ number_format($teamII->efic,1).' %' }}</font></td>
                              <td  style="text-align: center">{{ number_format($teamII->min_producidos,0) }}</td>
                              <td  style="text-align: center">{{ number_format($teamII->proyeccion_minutos,0) }}</td>
                    ...
                    <div class="col-lg-12 col-md-12">
                      ...
                      <thead>
                       ...
                       @foreach($planeacion as $plan)
                        @if($plan->planta == 'IntimarkI')
                          <tr>
                            <td style="text-align: left" class="sticky sticky-22 "><font size=2px">{{ $plan->team_leader}}</font></td>
                            <td style="text-align: center" class="sticky2 sticky-22"><font size=2px">{{ $plan->cliente}}</font></td>
                            <td style="text-align: center" class="sticky3 sticky-22"><font size=2px">{{ $plan->Modulo}}</font></td>
                            @foreach($planeacion_meta as $meta)
                              @if($plan->Modulo == $meta->Modulo)
                                <td style="text-align: center" class="sticky4 sticky-22"><font size=2px">{{ number_format($meta->piezas_meta,0)}}</font></td>
                                @if($meta->min_presencia_netos>0)
                                    <td style="text-align: center" class="sticky5 sticky-22"><font size=2px">{{ number_format(($meta->min_x_producir/$meta->min_presencia_netos)*100,1).' %'}}</font></td>
                                @else
                                    <td style="text-align: center" class="sticky5 sticky-22"><font size=2px">{{ number_format((0)*100,1).' %'}}</font></td>
                                @endif

                                @forelse($planeacion_09 as $plan09)
                                  @if($plan09->Modulo == $meta->Modulo)
                                    <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*1,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan09->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan09->efic,1).' %'}}</font></td>
                                  ...
                                  @endif
                                @empty
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                ...
                                @forelse($planeacion_10 as $plan10)
                                  @if($plan10->Modulo == $meta->Modulo)
                                    <td style="text-align: right" ><font size=2px">{{number_format(($meta->piezas_meta/$horas_laboradas)*2,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan10->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan10->efic,1).' %'}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan10->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan10->proyeccion_minutos,0)}}</font></td>
                                  @endif
                                @empty
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                ...
                                @forelse($planeacion_11 as $plan11)
                                  @if($plan11->Modulo == $meta->Modulo)
                                    <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*3,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan11->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan11->efic,1).' %'}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan11->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan11->proyeccion_minutos,0)}}</font></td>
                                  @endif
                                @empty
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                ...
                                @forelse($planeacion_12 as $plan12)
                                  @if($plan12->Modulo == $meta->Modulo)
                                    <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*4,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan12->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan12->efic,1).' %'}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan12->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan12->proyeccion_minutos,0)}}</font></td>
                                  @endif
                                @empty
                                   <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                ...
                                @forelse($planeacion_13 as $plan13)
                                  @if($plan13->Modulo == $meta->Modulo)
                                    <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*5,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan13->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan13->efic,1).' %'}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan13->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan13->proyeccion_minutos,0)}}</font></td>
                                  @endif
                                @empty
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                ...
                                @forelse($planeacion_14 as $plan14)
                                  @if($plan14->Modulo == $meta->Modulo)
                                    <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*5.5,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan14->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan14->efic,1).' %'}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan14->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan14->proyeccion_minutos,0)}}</font></td>
                                  @endif
                                @empty
                                   <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                ...
                                @forelse($planeacion_15 as $plan15)
                                  @if($plan15->Modulo == $meta->Modulo)
                                    <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*6.5,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan15->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan15->efic,1)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan15->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan15->proyeccion_minutos,0)}}</font></td>
                                  @endif
                               @empty
                                     <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                ...
                                @forelse($planeacion_16 as $plan16)
                                  @if($plan16->Modulo == $meta->Modulo)
                                  <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*7.5,0)}}</font></td>
                                  <td style="text-align: right" ><font size=2px">{{ number_format($plan16->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan16->efic,1).' %'}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan16->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan16->proyeccion_minutos,0)}}</font></td>
                                    @endif
                                @empty
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                ...
                                @forelse($planeacion_17 as $plan17)
                                  @if($plan17->Modulo == $meta->Modulo)
                                  <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*8.5,0)}}</font></td>
                                  <td style="text-align: right" ><font size=2px">{{ number_format($plan17->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan17->efic,1).' %'}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan17->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan17->proyeccion_minutos,0)}}</font></td>
                                  @endif
                                @empty
                                   <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                ...
                                @forelse($planeacion_18 as $plan18)
                                  @if($plan18->Modulo == $meta->Modulo)
                                  <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*9.5,0)}}</font></td>
                                  <td style="text-align: right" ><font size=2px">{{ number_format($plan18->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_Format($plan18->efic,1).' %'}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan18->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan18->proyeccion_minutos,0)}}</font></td>
                                  @endif
                                @empty
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                    ...
                    <table class="table-cebra table-fixed">
                      ...
                      <thead>
                       ...
                       <!-- <th style="text-align: center" class="sticky4">Estilo</th>-->
                        ...
                        <tbody>
                       @foreach($planeacion as $planII)
                        @if($planII->planta == 'IntimarkII')
                          <tr>
                            ...
                            @foreach($planeacion_meta as $meta)
                              @if($planII->Modulo == $meta->Modulo)
                                <td style="text-align: center" class="sticky4 sticky-22"><font size=2px">{{ number_format($meta->piezas_meta,0)}}</font></td>
                                <td style="text-align: center" class="sticky5 sticky-22"><font size=2px">{{ number_format($meta->eficiencia_dia,1).' %'}}</font></td>
                                @forelse($planeacion_09 as $plan09II)
                                  @if($plan09II->Modulo == $meta->Modulo)
                                  <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*1,0)}}</font></td>
                                  <td style="text-align: right" ><font size=2px">{{ number_format($plan09II->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan09II->efic,1).' %'}}</font></td>
                                ...
                                @empty
                                    ...
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                @endforelse
                                @forelse($planeacion_10 as $plan10II)
                                  @if($plan10II->Modulo == $meta->Modulo)
                                  <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*2,0)}}</font></td>
                                  <td style="text-align: right" ><font size=2px">{{ number_format($plan10II->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan10II->efic,1).' %'}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan10II->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan10II->proyeccion_minutos,0)}}</font></td>
                                  @endif
                                @empty
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                ...
                                @forelse($planeacion_11 as $plan11II)
                                  @if($plan11II->Modulo == $meta->Modulo)
                                  <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*3,0)}}</font></td>
                                  <td style="text-align: right" ><font size=2px">{{ number_format($plan11II->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan11II->efic,1).' %'}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan11II->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan11II->proyeccion_minutos,0)}}</font></td>
                                  @endif
                                @empty
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    ...
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                @endforelse
                                @forelse($planeacion_12 as $plan12II)
                                  @if($plan12II->Modulo == $meta->Modulo)
                                  <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*4,0)}}</font></td>
                                  <td style="text-align: right" ><font size=2px">{{ number_format($plan12II->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan12II->efic,1).' %'}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan12II->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan12II->proyeccion_minutos,0)}}</font></td>
                                  @endif
                                @empty
                                   <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    ...
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                @endforelse
                                @forelse($planeacion_13 as $plan13II)
                                  @if($plan13II->Modulo == $meta->Modulo)
                                  <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*5,0)}}</font></td>
                                  <td style="text-align: right" ><font size=2px">{{ number_format($plan13II->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan13II->efic,1).' %'}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan13II->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan13II->proyeccion_minutos,0)}}</font></td>
                                  @endif
                                @empty
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    ...
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                @endforelse
                                @forelse($planeacion_14 as $plan14II)
                                  @if($plan14II->Modulo == $meta->Modulo)
                                  <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*5.5,0)}}</font></td>
                                  <td style="text-align: right" ><font size=2px">{{ number_format($plan14II->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan14II->efic,1).' %'}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan14II->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan14II->proyeccion_minutos,0)}}</font></td>
                                  @endif
                                @empty
                                   <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    ...
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                @endforelse
                                @forelse($planeacion_15 as $plan15II)
                                  @if($plan15II->Modulo == $meta->Modulo)
                                  <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*6.5,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan15II->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan15II->efic,1)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan15II->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan15II->proyeccion_minutos,0)}}</font></td>
                                  @endif
                               @empty
                                     <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    ...
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                @endforelse
                                @forelse($planeacion_16 as $plan16II)
                                  @if($plan16II->Modulo == $meta->Modulo)
                                  <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*7.5,0)}}</font></td>
                                  <td style="text-align: right" ><font size=2px">{{ number_format($plan16II->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan16II->efic,1).' %'}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan16II->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan16II->proyeccion_minutos,0)}}</font></td>
                                    @endif
                                @empty
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    ...
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                @endforelse
                                @forelse($planeacion_17 as $plan17II)
                                  @if($plan17II->Modulo == $meta->Modulo)
                                  <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*8.5,0)}}</font></td>
                                  <td style="text-align: right" ><font size=2px">{{ number_format($plan17II->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan17II->efic,1).' %'}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan17II->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan17II->proyeccion_minutos,0)}}</font></td>
                                  @endif
                                @empty
                                   <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    ...
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                @endforelse
                                @forelse($planeacion_18 as $plan18II)
                                  @if($plan18II->Modulo == $meta->Modulo)
                                  <td style="text-align: right" ><font size=2px">{{ number_format(($meta->piezas_meta/$horas_laboradas)*9.5,0)}}</font></td>
                                  <td style="text-align: right" ><font size=2px">{{ number_format($plan18II->piezas,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan18II->efic,1).' %'}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan18II->min_producidos,0)}}</font></td>
                                    <td style="text-align: right" ><font size=2px">{{ number_format($plan18II->proyeccion_minutos,0)}}</font></td>
                                  @endif
                                @empty
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                                    <td style="text-align: center" ><font size=2px">{{ 0}}</font></td>
                ...
                <div class="tab-pane" id="messages">
                  <table class="table">
                    ...
                    @foreach($modulos as $mod)
                      ...
                      <tr>
                       ...
                       @php
                        $meta_modulo=($mod->piezas_meta/$horas_laboradas)*$valor_hora;
                       @endphp
                        <td  style="text-align: center">{{ number_format($meta_modulo,0) }}</td>
                        <td  style="text-align: center">{{ number_format($mod->eficiencia_dia,0).' %' }}</td>
                  ...
                  <table class="table-cebra table-fixed">
                    ...
                    <tbody>
                    @foreach($modulos as $modII)
                      @if($modII->planta == 'IntimarkII')
                      <tr>
                       ...
                       <!-- <td style="text-align: center">{{ $mod->piezas_meta }} </td>         -->
                       @php
                        $meta_modulo=($modII->piezas_meta/$horas_laboradas)*$valor_hora;
                       @endphp
                        <td  style="text-align: center">{{ number_format($meta_modulo,0) }}</td>
                        <td  style="text-align: center">{{ number_format($modII->eficiencia_dia,0).' %'}}</td>
                        <td  style="text-align: center">{{ number_format($modII->piezas,0) }}</td>
                        @if($modII->eficiencia_dia > $modII->efic)
                          @php
                            $color = "red";
                          @endphp
                        @else
                        ...
                        <td  style="text-align: center"><font color={{ $color }}>{{ number_format($modII->efic,0).' %' }}</font></td>
                        <td  style="text-align: center">{{ number_format($modII->min_producidos,0) }}</td>
                        <td  style="text-align: center">{{ number_format($modII->proyeccion_minutos,0) }}</td>
                  ...
                  <table class="table">
                    ...
                    @foreach($plantas as $planta)
                      <tr>
                        ...
                        <td class="text-info">{{ $planta->planta }} </td>
                       <!-- <td style="text-align: center">{{ $mod->piezas_meta }} </td>         -->
                       @php
                        $meta_planta=($planta->piezas_meta/$horas_laboradas)*$valor_hora;
                       @endphp
                        <td  style="text-align: center">{{ number_format($meta_planta,0) }}</td>
                        <td  style="text-align: center">{{ number_format($planta->eficiencia_dia,0) }}</td>
                        <td  style="text-align: center">{{ number_format($planta->piezas,0) }}</td>
                        @if($planta->eficiencia_dia > $planta->efic)
                          @php
                            $color = "red";
                          @endphp
                        @else
                        ...
                        <td  style="text-align: center"><font color={{ $color }}>{{ number_format($planta->efic,0).' %' }}</font></td>
                        <td  style="text-align: center">{{ number_format($planta->min_producidos,0) }}</td>
                        <td  style="text-align: center">{{ number_format($planta->proyeccion_minutos,0) }}</td>
