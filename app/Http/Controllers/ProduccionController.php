...
class ProduccionController extends Controller
{
    ...
    public function actualizarTabla(Request $request)
    {
        ...
        // Reiniciar las columnas de la semana actual
        ...
        foreach ($request->semanas as $idProduccion => $semanas) {
            ...
            if ($produccion) {
                // Reiniciar la columna semana actual a 0
                $produccion->$semanaColumn = 0;

                // Actualizar según los checkboxes seleccionados
                if (isset($semanas[$semanaColumn])) {
                    $produccion->$semanaColumn = $semanas[$semanaColumn];
                }
